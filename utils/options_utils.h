...
static void setup_options(int argc, const char* argv[])
{
  ...
  desc.add_options()
    ...
    ("bfs_per_page", 
     boost::program_options::value<unsigned long>()->default_value(0),
      "number of bloom filter per page")
    ("bits_per_BF", 
     boost::program_options::value<unsigned long>()->default_value(0),
      "number of bits per bloom filter")
    ("chip_v_once",
     boost::program_options::value<unsigned long>()->default_value(0),
      "vertexes sent to chips should be multiple of this value")
    ("max_check_v",
     boost::program_options::value<unsigned long>()->default_value(0),
      "maximum number of vertexes the FPGA can process")
    ("kernel",
     boost::program_options::value<std::string>()->default_value(""),
      "bloom filter kernel type: FPGA or CPU")
    ("page_size",
     boost::program_options::value<unsigned long>()->default_value(0),
      "page size used for random reads")
      ("bf_mode",
      boost::program_options::value<std::string>()->default_value("create"),
      "bloom filter create/verify/update/use");
