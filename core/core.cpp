...
namespace algorithm {
  ...
  int sg_pcpu::partition;
  std::vector<vertex_t, boost::alignment::aligned_allocator<vertex_t, 4096> > sg_pcpu::all_BF_vertex;
  unsigned int sg_pcpu::all_BF_cnt;
  vertex_t **sg_pcpu::BF_vertex;
  int *sg_pcpu::BF_vertex_cnt;
  int *sg_pcpu::BF_vertex_nr;
  std::vector<unsigned char, boost::alignment::aligned_allocator<unsigned char, 4096> > sg_pcpu::BF_bitset;
  std::vector<unsigned char, boost::alignment::aligned_allocator<unsigned char, 4096> > sg_pcpu::ver_buf_chg;
  unsigned char sg_pcpu::count_table[256];
  //cl::Context *sg_pcpu::context;
  //cl::CommandQueue *sg_pcpu::q;
  //cl::Program *sg_pcpu::program;
