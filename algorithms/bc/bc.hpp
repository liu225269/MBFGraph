    ...
    namespace bc {
        ...
        void bc<F>::operator()() {
            ...
            do {
                ...
                if (heartbeat) {
                    BOOST_LOG_TRIVIAL(info) << clock::timestamp(&prev, &cur) << " Completed one fwd pass ";
                }
            } while (1);
            ...
            do {
                ...
                if (heartbeat) {
                    BOOST_LOG_TRIVIAL(info) << clock::timestamp(&prev, &cur) << " Completed one rev pass";
                }
            } while (1);
